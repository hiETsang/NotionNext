...
const LayoutBase = props => {
  ...
  return (
        <ThemeGlobalNobelium.Provider value={{ searchModal, filterKey, setFilterKey }}>
            <div id='theme-nobelium' className={`${siteConfig('FONT_STYLE')} nobelium antialiased relative dark:text-gray-300  w-full  bg-white dark:bg-[#2a2c31] min-h-screen flex flex-col scroll-smooth`}>
                <Style />
